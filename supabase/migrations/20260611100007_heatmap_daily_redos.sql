-- ============================================================
-- Migration: get_dashboard_overview() — add per-day redo counts to heatmapLabs
-- Purpose: The client heatmap needs per-day redo counts per lab to render a
--          TOTAL REDO CASE/DAY footer row. Adds a `redos` day→redo-count map
--          (days with at least one redo only, to keep the payload sparse).
--          Identical to 20260611100005_heatmap_daily_amounts.sql otherwise.
-- ============================================================
